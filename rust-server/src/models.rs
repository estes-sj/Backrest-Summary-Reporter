...
pub struct EventTotals {
    ...
    pub total_forget_warning:    i64,
    pub total_forget_error:      i64,
    pub total_prune_success:     i64,
    pub total_prune_warning:     i64,
    pub total_prune_error:       i64,
    pub total_check_success:     i64,
    pub total_check_warning:     i64,
    pub total_check_error:       i64,
